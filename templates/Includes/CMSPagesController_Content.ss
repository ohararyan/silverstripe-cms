<div id="pages-controller-cms-content" class="cms-content center cms-tabset $BaseCSSClasses" data-layout-type="border" data-pjax-fragment="Content">
	...
	<div class="cms-content-header north">
		...
		<div class="cms-content-header-tabs">
			<button id="filters-button" class="icon-button font-icon-search no-text" data-collapsed="$DisplayFilters" title="<% _t('CMSPagesController_Tools_ss.FILTER', 'Filter') %>"></button>
